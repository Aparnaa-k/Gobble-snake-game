...
function createSnake(){
    ...
    snake.forEach((snakePart) => {
        ...
        context.arcTo(x + unit, y + unit, x + unit - cornerRadius, y + unit, cornerRadius);
...
function keyPress(event){
    ...
    const right = 39;
    const down = 40;
    up_arrow.addEventListener("click",()=>{xVel=0;
            yVel =-unit;})
    down_arrow.addEventListener("click",()=>{xVel=0;
            yVel=unit;})
    left_arrow.addEventListener("click",()=>{xVel =-unit;
            yVel = 0})
    right_arrow.addEventListener("click",()=>{xVel=unit;
            yVel=0;})
    switch(true){
